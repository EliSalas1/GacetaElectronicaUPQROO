...
Este directorio contiene los componentes del panel de supervisor, siguiendo estrictamente los principios SOLID y con funcionalidades de filtrado.
...
const pendientesFilter = useTableFilter(pendientesData || [], pendientesFilterConfig)
const historialFilter = useTableFilter(historialData || [], historialFilterConfig)
```
